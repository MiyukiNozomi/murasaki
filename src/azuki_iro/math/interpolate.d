...
module azuki_iro.math.interpolate;

private {
    import azuki_iro.math.linalg : Vector, dot, vec2, vec3, vec4, quat;
    import azuki_iro.math.util : is_vector, is_quaternion;
    import azuki_iro.math.math : almost_equal, acos, sin, sqrt, clamp, PI;
    import std.conv : to;
}
